...
export class Backend implements backendInterface {
    ...
    async createPost(arg0: string, arg1: string, arg2: Array<string>): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async updatePost(arg0: bigint, arg1: string, arg2: string, arg3: Array<string>): Promise<void> {
        if (this.processError) {
            try {
